...
if ($id == '' || $username == '' || $pass == ''|| $name == ''|| $sem == ''|| $email == ''|| $phone == ''|| $aadhar == ''|| $dob == '')
...
renderForm($username, $pass, $name,$sem,$email,$phone,$aadhar,$dob);
...
mysqli_query($con,"INSERT student SET id=$id ,username='$username', pass='$pass' , name='$name', sem='$sem', email='$email', phone='$phone', aadhar='$aadhar', dob='$dob'")
