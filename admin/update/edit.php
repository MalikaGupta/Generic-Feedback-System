...
function renderForm($id,$username,$pass,$name,$sem,$email,$phone,$aadhar,$dob,$error)
...
if ($username == '' || $pass == ''|| $name == ''|| $sem == ''|| $email == ''|| $phone == ''|| $aadhar == ''|| $dob == '')
...
renderForm($id,$username, $pass, $name,$sem,$email,$phone,$aadhar,$dob);
...
mysqli_query($con,"UPDATE student SET  username='$username', pass='$pass' , name='$name', sem='$sem', email='$email', phone='$phone', aadhar='$aadhar', dob='$dob' WHERE id=(SELECT $id )")
