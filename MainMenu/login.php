														...
														<?php
																if (isset($_POST['login']))
																		...
																		if (isset($_POST['register']))
																		{
																			...
																			$query = "INSERT INTO student (username, pass, name, sem, email, phone, aadhar, dob, aictid, branch) VALUES ('".$rollno."','". $password."','". $firstname." ".$lastname."','". $semester."','". $email."','". $phone."','". $aadhar."','". $year."-".$month."-". $date."','".$aictid."','".$branch."')";															
