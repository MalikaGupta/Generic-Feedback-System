...
<html>
            ...
            <div class="carousel carousel-slider center" data-indicators="true" style="height: 610px;">
                ...
                <div class="carousel-item  white-text" href="#one!">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>How is the assistance and aminities provided at the college sports ground?</td>
                            ...
                            <tr>
                                <td>how would you describe the collection of books,journels and reading material of college library?</td>
                            ...
                            <tr>
                                <td>Rate the support and the assistance of college staff?</td>
                            ...
                            <tr>
                                <td>According to you, the greenary in the college campus is ?</td>
                            ...
                            <tr>
                                <td>The drinking water facility of college is?</td>
                            ...
                            <tr>
                                <td>Rate the washroom cleanliness and maintanance?</td>
                                <td><input name="g6" type="radio" id="test21" value='5' /><label for="test21"></label></td>
                                <td><input name="g6" type="radio" id="test22" value='20' /><label for="test22"></label></td>
	...
	if(isset($_POST['submit'])){
		...
		$query="INSERT INTO fedother (avg) VALUES('".$selecval."')";
