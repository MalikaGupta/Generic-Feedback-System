...
<html>
    ...
    <body background="im59020159.jpg">
        ...
        <h2 style="text-align:center;">Canteen</h2>
        <form action="#">        
            <div class="carousel carousel-slider center" data-indicators="true" style="height: 610px;">
                <div class="carousel-fixed-item center">
                   <a href="feedbackinsti.php"  class="btn waves-effect waves-effect grey white-text darken-text-4" type="submit" name="action" >Submit
                ...
                <div class="carousel-item  white-text" href="#one!">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>How hygienic is the dining area of cafeteria?</td>
                            ...
                            <tr>
                                <td>To what extent is diret contact by serving staff avoided with food item by the means of gloves?</td>
                            ...
                            <tr>
                                <td>How fresh are the food item being served?</td>
                            ...
                            <tr>
                                <td>Your review of the food being served accordingly to taste would be?</td>
                            ...
                            <tr>
                                <td>How economical are the price?</td>
                            ...
                            <tr>
                                <td>How according to you is the choice of menue?</td>
